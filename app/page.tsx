...
export default function Home() {
  return (
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-10 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          <h3 className="text-gray-200 hidden md:block">
          I am Vedant Upadhye a full stack web-developer
          </h3>
